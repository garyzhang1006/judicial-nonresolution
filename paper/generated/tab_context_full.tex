...
\begin{tabular}{llrcr}
\toprule
split & context & $\Delta F_1$ & 95\% CI & $P(\Delta{>}0)$ \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Paired bootstrap on the effect of widening the context window, relative to the anchor sentence alone, for the sparse model. Resamples are paired across conditions.}
\label{tab:context}
\end{table}
