...
\bottomrule
\end{tabular}
\caption{Opinions containing at least one dictionary expression, by court. $N$ is eligible opinions and $k$ those with at least one expression. Intervals are Wilson \citep{wilson1927probable}.}
\label{tab:prevcourt}
\end{table*}
